*this project(webapp) belongs to the work came to my company
*i created this one with Servlet back then at company, 
*i also have uploaded repository having this same webaap with Spring as well as in other repository you will find this webapp with Spring Boot,
